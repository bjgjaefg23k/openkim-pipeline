...
def CreateBatch(template, prefix, driver):
    ...
    for surface in surfaces:
        for symbol in symbols:
            ...
            finname = prefix+surface+symbol
            shutil.copytree(template, newname) 
            ConvertName(newname, finname, driver, {"SYMBOL": symbol, "SURFACE": surface})
    
if __name__ == "__main__":
    CreateBatch("test_surfaces", "SurfaceEnergyFCC", "TD_111111111111_000")
    ConvertBatch("SurfaceEnergyFCC", "TE_111111111", "TD_111111111111_000")
